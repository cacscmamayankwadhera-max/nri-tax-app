  ...
  return (
    <div className="min-h-screen bg-[#f5f2ec]">
      ...
      <div className="max-w-3xl mx-auto py-12 px-6">
        <h1 className="font-serif text-3xl font-bold text-[#1a1a1a] mb-2">Terms of Service</h1>
        <p className="text-sm text-gray-500 mb-10">Last updated: 23 March 2026</p>

        <div className="space-y-8 text-sm text-gray-700 leading-relaxed">
          {/* 1 */}
          <section>
            <h2 className="font-serif text-lg font-bold text-[#1a1a1a] mb-3 border-b border-[#C49A3C]/30 pb-2">1. Service Description</h2>
            <p>
          ...
          {/* 2 */}
          <section>
            <h2 className="font-serif text-lg font-bold text-[#1a1a1a] mb-3 border-b border-[#C49A3C]/30 pb-2">2. User Obligations</h2>
          ...
          {/* 3 */}
          <section>
            <h2 className="font-serif text-lg font-bold text-[#1a1a1a] mb-3 border-b border-[#C49A3C]/30 pb-2">3. Limitation of Liability</h2>
            <p>
          ...
          {/* 4 */}
          <section>
            <h2 className="font-serif text-lg font-bold text-[#1a1a1a] mb-3 border-b border-[#C49A3C]/30 pb-2">4. AI Disclaimer</h2>
            <p>
          ...
          {/* 5 */}
          <section>
            <h2 className="font-serif text-lg font-bold text-[#1a1a1a] mb-3 border-b border-[#C49A3C]/30 pb-2">5. Data Handling</h2>
            <p>
            ...
            <p className="mt-3">
              ...
              <a href="/privacy" className="text-[#C49A3C] underline hover:text-amber-600 transition-colors">Privacy Policy</a>.
            </p>
          </section>

          {/* 6 */}
          <section>
            <h2 className="font-serif text-lg font-bold text-[#1a1a1a] mb-3 border-b border-[#C49A3C]/30 pb-2">6. Payment Terms</h2>
          ...
          {/* 7 */}
          <section>
            <h2 className="font-serif text-lg font-bold text-[#1a1a1a] mb-3 border-b border-[#C49A3C]/30 pb-2">7. Governing Law and Jurisdiction</h2>
            <p>
          ...
          {/* 8 */}
          <section>
            <h2 className="font-serif text-lg font-bold text-[#1a1a1a] mb-3 border-b border-[#C49A3C]/30 pb-2">8. Changes to Terms</h2>
            <p>
      ...
      <footer className="bg-[#1a1a1a] text-gray-400 text-center py-8 mt-12">
        ...
        <div className="flex justify-center gap-6 mt-4 text-xs">
          <a href="/terms" className="text-[#C49A3C] hover:text-amber-300 transition-colors">Terms of Service</a>
