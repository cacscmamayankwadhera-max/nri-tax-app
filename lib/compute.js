...
export function computeHouseProperty(annualRent, municipalTax = 0, loanInterest = 0, isSelfOccupied = false, preConstructionInterest = 0, _preConstructionYear = 0) {
...
export function computeUnlistedSharesCG(salePrice, purchaseCost, holdingMonths, _acqFY, _saleFY) {
