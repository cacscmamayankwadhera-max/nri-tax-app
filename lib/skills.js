...
NOTE FOR NRIs: Post Finance Act 2024, NRIs MUST use 12.5% flat rate (Option B). The dual option is available ONLY to resident individuals and HUFs. Still compute both options for advisory context, but clearly state that NRIs are legally bound to Option B.
