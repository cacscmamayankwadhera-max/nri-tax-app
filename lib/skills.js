...
- Schedule FA: mandatory for returning NRIs (RNOR/Resident) — list specific items (bank accounts, financial interests, immovable property, signing authority).
- Schedule AL: if income >₹50L, mandatory — immovable property, movable property, bank balances, shares, cash in hand.
