---
title: "NRI Income Tax Notice — Types, Response & How to Handle (2026)"
description: "Complete guide for NRIs on handling income tax notices from India. Covers Section 143(1), 143(2), 148/148A, 245, 133(6), 139(9), and 154 notices — response timelines, e-proceedings, penalty provisions, appeal process, and practical resolution strategies."
...
keywords:
  ...
  - NRI tax notice India
  - how to respond to income tax notice NRI
  - Section 143(1) intimation NRI
  - Section 148 reassessment NRI
  - NRI scrutiny notice
  - AIS mismatch NRI
  - income tax notice response from abroad
  - NRI tax demand notice
  - e-proceedings NRI
  - NRI income tax penalty
  - Section 270A penalty NRI
  - NRI property sale tax notice
  - TDS mismatch NRI notice
  - NRI defective return notice
  - income tax notice types India 2026
  - NRI tax compliance India
  - CIT Appeal NRI
  - ITAT NRI appeal
  - NRI refund adjustment notice
...
1. **Log in** to [incometax.gov.in](https://www.incometax.gov.in) using your PAN and password
...
| Notice Type | Section | Response Deadline | Extension Possible? |
|---|---|---|---|
| Intimation | 143(1) | 30 days from receipt | File rectification u/s 154 |
| Scrutiny | 143(2) | 15 days (extendable) | Yes, through e-Proceedings |
| Reassessment Show Cause | 148A(b) | 7-30 days | Limited |
| Reassessment | 148 | 30 days to file return | Yes, with AO permission |
| Refund Adjustment | 245 | 30 days | No — deemed accepted if no response |
| Information Sought | 133(6) | 15-30 days | Yes, with written request |
| Defective Return | 139(9) | 15 days | Yes, with written request |
| Rectification | 154 | Within 4 years | N/A |
...
- [Schedule a consultation on our portal](/client)
