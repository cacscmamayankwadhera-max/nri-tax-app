---
slug: nri-income-tax-filing-india-itr-guide-ay-2026-27
title: "NRI Income Tax Filing in India — Complete ITR Guide for AY 2026-27 (FY 2025-26)"
meta_description: "Comprehensive guide for NRIs on filing income tax returns in India for AY 2026-27. Covers ITR form selection, new vs old regime, TDS refund, capital gains, rental income, and common mistakes. Expert guidance by CA Mayank Wadhera."
...
> "Most NRIs either overpay their taxes by not claiming legitimate TDS refunds, or face unnecessary scrutiny because they filed the wrong form or missed disclosing income that already appears in their AIS. A systematic, well-informed approach to filing can save you both money and stress."
...
> "I have seen hundreds of NRI returns filed on ITR-1 by well-meaning family members or uninformed tax preparers. Every single one is technically a defective return. The department may process it initially, but it creates risk during scrutiny."
> — **CA Mayank Wadhera**
...
> "Every filing season, we get dozens of calls from NRIs who used online tax calculators that applied Section 87A. Always confirm the tool accounts for NRI status — or work with a qualified CA."
> — **CA Mayank Wadhera**
...
1. Banks may report NRE interest in AIS — even though exempt, it can be flagged as unreported
2. Property transactions show sale price, TDS, and stamp duty value — any mismatch triggers notices
3. All MF redemptions, dividends, and share transactions are captured
4. Multiple TDS credits from different deductors must be verified
...
> "Even ₹78,000 recovered every year adds up significantly over a decade. File your return."
> — **CA Mayank Wadhera**
...
1. **Filing ITR-1** — NRIs cannot use Sahaj; results in defective return
2. **Not disclosing all income** — AIS captures everything; omissions trigger notices
3. **Including NRE interest as taxable** — Inflates income, unnecessary tax
4. **Claiming Section 87A rebate** — Not available for NRIs; leads to demand notice
5. **Wrong residential status** — Selecting "Resident" makes global income taxable
6. **Missing TDS credits** — Leaving money with the government
7. **Not comparing regimes** — Running both can save significant tax
8. **Ignoring DTAA benefits** — Results in double taxation
9. **Not filing at all** — "TDS already deducted" loses you the refund
10. **Filing late** — Loses carry-forward and regime choice
...
[Get Your Free Assessment →](/client)

**WhatsApp:** [+91-96677 44073](https://wa.me/919667744073)
**Email:** [contact@mkwadvisors.com](mailto:contact@mkwadvisors.com)

*We serve NRIs across USA, UK, UAE, Singapore, Canada, Australia, and 30+ countries.*

---

*Disclaimer: This article is for informational purposes only and does not constitute legal or tax advice. Tax laws are subject to change. For personalized advice, consult a qualified Chartered Accountant. Last updated: March 2026.*

*MKW Advisors | Legal Suvidha | DigiComply — Trusted by NRIs across 30+ countries.*
