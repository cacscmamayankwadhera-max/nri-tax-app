---
title: "Tax Saving Strategies for NRIs in India — Complete Deduction & Exemption Guide (2026)"
description: "Comprehensive guide to NRI tax saving in India for FY 2025-26. Covers old vs new regime, Section 80C, 80D, 24, 54/54EC/54F, NRE interest exemption, GIFT City zero-tax route, Section 197 lower TDS, tax-loss harvesting, and 10+ FAQs."
...
canonical: "/blogs/nri-tax-saving-strategies-india-2026"
---
...
> **Need a personalized NRI tax plan?** Our team of Chartered Accountants specializes exclusively in NRI taxation. [Book a consultation now](/client) or WhatsApp us at **+91-96677 44073**.

---

## Table of Contents

1. [New Regime vs Old Regime: What NRIs Must Know](#new-regime-vs-old-regime)
2. [Section 80C Deductions for NRIs (up to Rs 1.5 Lakh)](#section-80c-deductions-for-nris)
3. [Section 80D: Health Insurance Premium Deduction](#section-80d-health-insurance)
4. [Section 24: Home Loan Interest Deduction](#section-24-home-loan-interest)
5. [Capital Gains Exemptions: Section 54, 54EC, and 54F](#capital-gains-exemptions)
6. [Section 80TTA / 80TTB: Savings Interest Deduction](#section-80tta-80ttb)
7. [NRE Interest Exemption under Section 10(4)(ii)](#nre-interest-exemption)
8. [GIFT City: The Zero-Tax Route for NRI Investments](#gift-city-zero-tax-route)
9. [Standard Deduction of Rs 75,000 (New Regime)](#standard-deduction)
10. [Section 197: Lower TDS Certificate](#section-197-lower-tds)
11. [Tax-Loss Harvesting on Equity Investments](#tax-loss-harvesting)
12. [Timing Strategies: Choosing the Right Financial Year](#timing-strategies)
13. [New Regime Slab Benefit Analysis with Examples](#new-regime-slab-analysis)
14. [Comparison Table: Old Regime vs New Regime Deductions for NRIs](#comparison-table)
15. [Common Mistakes NRIs Make](#common-mistakes)
16. [FAQs — NRI Tax Saving in India](#faqs)

---

<a id="new-regime-vs-old-regime"></a>
## 1. New Regime vs Old Regime: What NRIs Must Know for FY 2025-26
...
<a id="section-80c-deductions-for-nris"></a>
## 2. Section 80C Deductions for NRIs (Up to Rs 1,50,000)
...
| Instrument | Available? | Notes |
|---|---|---|
| **ELSS (Equity Linked Savings Scheme)** | Yes | 3-year lock-in. NRIs can invest through NRE/NRO accounts. Some AMCs restrict NRIs from certain countries (US, Canada) due to FATCA compliance. |
| **Life Insurance Premium** | Yes | Premium paid for self, spouse, or children. Policy must be from an Indian insurer. |
| **Tuition Fees** | Yes | Fees paid for up to 2 children studying in India. Must be for full-time education at a recognized institution. |
| **Home Loan Principal Repayment** | Yes | Repayment of principal on a housing loan for a property in India. |
| **Stamp Duty and Registration Charges** | Yes | Paid during the year of purchase of a residential property in India. |
| **NSC (National Savings Certificate)** | Partially | NRIs cannot make fresh investments. However, NSC purchased while resident continues to qualify until maturity. Accrued interest on NSC also qualifies. |
| **Sukanya Samriddhi Yojana** | No | Account must be closed or converted upon becoming NRI. |
| **PPF (Public Provident Fund)** | No new deposits | NRIs cannot open new PPF accounts. Existing PPF accounts (opened while resident) can be maintained until maturity at the prevailing interest rate but **no fresh deposits are allowed**. The account will earn interest until maturity. |
| **5-Year Tax Saving FD** | Yes | Available through NRO accounts with select banks. |
| **Senior Citizens Savings Scheme** | No | Not available to NRIs. |
| **NPS (National Pension System)** | Yes | NRIs can open NPS accounts. Additional Rs 50,000 deduction under Section 80CCD(1B) is available under the old regime. Note: NPS contribution by employer up to 14% of salary is deductible even under new regime. |
...
> **Need help identifying the right 80C instruments for your specific country of residence?** Contact our NRI tax specialists at **contact@mkwadvisors.com** or [schedule a call](/client).

---

<a id="section-80d-health-insurance"></a>
...
|---|---|
| Self, spouse, dependent children | Rs 25,000 (Rs 50,000 if any insured is 60+) |
| Parents | Rs 25,000 (Rs 50,000 if parent is 60+) |
| Preventive health check-up | Rs 5,000 (within overall limit) |
| **Maximum combined** | **Rs 1,00,000** (if self 60+ and parents 60+) |
...
<a id="section-24-home-loan-interest"></a>
...
|---|---|---|
| Self-occupied | Up to Rs 2,00,000 | Rs 2,00,000 (only if 2 self-occupied properties declared; otherwise treated as deemed let-out) |
| Let-out / Deemed let-out | No upper limit (entire interest deductible) | No upper limit (entire interest deductible) |
...
<a id="capital-gains-exemptions"></a>
...
> **Selling property in India? Get a customized capital gains tax plan before you sign.** [Book a consultation](/client) or WhatsApp **+91-96677 44073**.

---

<a id="section-80tta-80ttb"></a>
## 6. Section 80TTA / 80TTB: Savings Account Interest Deduction
...
<a id="nre-interest-exemption"></a>
## 7. NRE Interest Exemption: Section 10(4)(ii) — The Single Biggest NRI Tax Saver
...
|---|---|---|
| Interest taxability | Exempt under Section 10(4)(ii) | Fully taxable |
| TDS on interest | Nil | 30% + cess (Section 195) |
| Repatriation | Fully repatriable | Up to USD 1 million per FY (after tax and CA certificate) |
| Source of funds | Foreign earnings, remittances from abroad | Indian income (rent, dividends, pension) |
...
<a id="gift-city-zero-tax-route"></a>
...
<a id="standard-deduction"></a>
## 9. Standard Deduction: Rs 75,000 Under the New Regime
...
<a id="section-197-lower-tds"></a>
## 10. Section 197: Lower TDS Certificate — Stop Overpaying the Government
...
> **We handle Section 197 applications for NRIs across India.** Our CA team files Form 13, coordinates with the Assessing Officer, and ensures you get the lower TDS certificate before your transaction closes. [Start now](/client) or email **contact@mkwadvisors.com**.

---

<a id="tax-loss-harvesting"></a>
...
<a id="timing-strategies"></a>
## 12. Timing Strategies: Choosing the Right Financial Year to Recognize Income
...
<a id="new-regime-slab-analysis"></a>
## 13. New Regime Slab Benefit Analysis with Worked Examples
...
| **Taxable Income** | **Rs 12,00,000** | **Rs 14,00,000** |
| Tax | Rs 1,72,500 | Rs 1,50,000 |
| Cess (4%) | Rs 6,900 | Rs 6,000 |
| **Total Tax** | **Rs 1,79,400** | **Rs 1,56,000** |
| **Saving** | | **Rs 23,400 (New Regime wins)** |
...
| **Taxable Income** | **Rs 19,50,000** | **Rs 23,00,000** |
| Tax | Rs 4,02,500 | Rs 4,75,000 |
| Cess (4%) | Rs 16,100 | Rs 19,000 |
| **Total Tax** | **Rs 4,18,600** | **Rs 4,94,000** |
| **Saving** | **Rs 75,400 (Old Regime wins)** | |
...
> **Not sure which regime saves you more tax?** Our team runs a personalized tax simulation for your specific income profile. [Get your analysis](/client).

---

<a id="comparison-table"></a>
## 14. Comparison Table: Deductions Available in Old vs New Regime for NRIs

| Deduction / Exemption | Section | Old Regime | New Regime |
|---|---|---|---|
| Standard Deduction (salaried) | 16(ia) | Rs 50,000 | Rs 75,000 |
| PPF / ELSS / Life Insurance / NSC | 80C | Up to Rs 1,50,000 | Not available |
| NPS Employee Contribution | 80CCD(1) | Within 80C limit | Not available |
| NPS Employer Contribution | 80CCD(2) | Up to 10% of salary | Up to 14% of salary |
| Health Insurance Premium | 80D | Up to Rs 1,00,000 | Not available |
| Home Loan Interest (self-occupied) | 24(b) | Up to Rs 2,00,000 | Not available (unless 2 self-occupied) |
| Home Loan Interest (let-out) | 24(b) | No cap | No cap |
| Savings Account Interest | 80TTA | Up to Rs 10,000 | Not available |
| Donation to Charity | 80G | Varies | Not available |
| NRE Interest Exemption | 10(4)(ii) | Fully exempt | Fully exempt |
| Capital Gains Exemption | 54/54EC/54F | Available | Available |
| HRA Exemption | 10(13A) | Available | Not available |
| LTA (Leave Travel Allowance) | 10(5) | Available | Not available |
| Set-off of House Property Loss | 71 | Up to Rs 2,00,000 | Only against HP income |
| Section 87A Rebate | 87A | Up to Rs 12,500 (NOT for NRIs) | Up to Rs 60,000 (NOT for NRIs) |
| Family Pension Deduction | 57(iia) | Rs 15,000 | Rs 25,000 |
...
## 15. Common Mistakes NRIs Make in Tax Planning
...
<a id="faqs"></a>
## 16. Frequently Asked Questions: NRI Tax Saving in India
...
- [Book a consultation with our NRI tax experts](/client)
