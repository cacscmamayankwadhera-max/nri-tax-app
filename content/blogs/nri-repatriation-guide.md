---
title: "NRI Money Repatriation from India — Form 15CA/CB, Limits & Complete Process (2026)"
description: "Definitive guide on repatriating money from India as an NRI. Covers NRE vs NRO accounts, Form 15CA (Parts A-D), Form 15CB CA certificate, FEMA limits, RBI guidelines, property sale proceeds, inheritance funds, RFC accounts, bank documentation, and step-by-step timelines."
author: "CA Mayank Wadhera (CA|CS|CMA|IBBI Registered Valuer)"
organization: "MKW Advisors | Legal Suvidha | DigiComply"
date: "2026-03-23"
lastmod: "2026-03-23"
slug: "nri-money-repatriation-india-form-15ca-15cb-limits-process-2026"
keywords:
  - NRI repatriation from India
  - Form 15CA
  - Form 15CB
  - NRO account repatriation limit
  - NRE account repatriation
  - NRI property sale repatriation
  - NRI inheritance repatriation India
  - FEMA repatriation rules NRI
  - RBI guidelines NRI remittance
  - RFC account returning NRI
  - how to repatriate money from India
  - NRI money transfer abroad from India
  - Form 15CA Part A B C D
  - CA certificate for NRI remittance
  - NRI tax clearance repatriation
categories:
  - NRI Taxation
  - FEMA Compliance
...
tags:
  ...
  - property sale
  - inheritance
canonical: "/blogs/nri-money-repatriation-india-form-15ca-15cb-limits-process-2026"
structured_data:
  type: "Article"
...
1. [NRE vs NRO Accounts — The Repatriation Foundation](#nre-vs-nro-accounts)
2. [Repatriation Limits Under FEMA and RBI Guidelines](#repatriation-limits)
3. [Form 15CA — The Four Parts Explained](#form-15ca)
4. [Form 15CB — The CA Certificate](#form-15cb)
5. [Step-by-Step Repatriation Process](#step-by-step-process)
6. [Documents Required for Repatriation](#documents-required)
7. [Property Sale Repatriation — Special Rules](#property-sale-repatriation)
8. [Inheritance and Gift Repatriation](#inheritance-repatriation)
9. [RFC Account for Returning NRIs](#rfc-account)
10. [Tax Clearance and Income Tax Compliance](#tax-clearance)
11. [Common Bank Rejections and How to Fix Them](#common-rejections)
12. [Timeline — What to Realistically Expect](#timeline)
...
|-----------|------------|-------------|
| Source of funds | Foreign earnings | Indian-source income |
| Repatriation limit | Unlimited | USD 1 million/FY |
| Form 15CA/CB | Not required | Required (above thresholds) |
| Tax on interest | Exempt | Taxable (30%+ TDS) |
| RBI approval | Not needed | Not needed (within limit) |
...
| Scenario | Part to File | Form 15CB Needed? |
|----------|-------------|-------------------|
| Aggregate remittance below Rs 5 lakh (taxable) | Part A | No |
| Payment in Rule 37BB notified list | Part B | No |
| Aggregate above Rs 5 lakh (taxable) | Part C | Yes |
...
**Need Form 15CB certification?** [Get expert CA assistance for your repatriation ->](/client)
...
**Planning to return to India?** [Consult our experts on RFC and RNOR tax planning ->](/client)
...
| Step | Duration | Notes |
|------|----------|-------|
| Tax computation and ITR filing | 1-2 weeks | Depends on complexity; property sale capital gains take longer |
| Section 197 certificate (if needed) | 2-4 weeks | AO processing time varies by jurisdiction |
| Form 15CB from CA | 3-5 days | After all tax documents are in order |
| Form 15CA filing | 1 day | Online process, immediate acknowledgment |
| Bank document submission and review | 1-2 weeks | Banks often come back with queries |
| Bank internal processing | 3-7 days | Compliance checks, FEMA verification |
| Wire transfer execution | 1-2 days | SWIFT transfer |
| Funds received abroad | 2-5 days | Depending on correspondent banks |
...
- [Schedule a consultation with our NRI tax experts ->](/client)
- **WhatsApp**: [+91-96677 44073](https://wa.me/919667744073) — Send us your repatriation query for a quick assessment
- **Email**: [contact@mkwadvisors.com](mailto:contact@mkwadvisors.com) — Share your documents for a detailed review
